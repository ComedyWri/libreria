...
Esta aplicación funciona cómo backend para una página de comercio de libros. Utiliza las tecnologías NodeJS y Express para controlar el backend y, Cloudinary como almacenamiento
de imágenes en las nubes.